...
local servers = {
  ...
  tailwind = { server_name = "tailwindcss" },
  angular = {
    server_name = "angularls",
    filetypes = { "html", "typescript" },
    root_pattern = { "angular.json", "package.json" },
  },
  dart = { server_name = "dartls", mason = false },
  lua = { server_name = "lua_ls" },
...
return {
...

  {
    ...
    config = function()
      ...
      mason.setup()
      local mason_servers = {}
      for key, cfg in pairs(servers) do
      ...
      for _, cfg in pairs(servers) do
        ...
        local opts = {
          ...
          root_dir = cfg.root_pattern and util.root_pattern(unpack(cfg.root_pattern)) or nil,
        }
